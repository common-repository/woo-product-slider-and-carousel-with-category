...
<div id="wcpscwc_review_tabs" class="wcpscwc-vtab-cnt wcpscwc_review_tabs wcpscwc-clearfix">
	<!-- Start - Testimonial Section -->
	<div class="wcpscwc-sf-testimonial-wrap">
		<div class="wcpscwc-center wcpscwc-features-ttl">
			<h1 class="wcpscwc-sf-heading">Looking for a Reason to Use <span class="wcpscwc-sf-blue">Essential Plugin </span>with Woo Product Slider?</h1>
			<div class="wcpscwc-sf-cont wcpscwc-sf-center"> Here are 50+...</div>
		</div>
		<div class="wcpscwc-testimonial-section-inr">
			...
			<a href="https://wordpress.org/support/plugin/woo-product-slider-and-carousel-with-category/reviews/?filter=5" target="_blank" class="wcpscwc-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a>
		</div>
	</div>
